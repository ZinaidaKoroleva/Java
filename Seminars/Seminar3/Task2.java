...
public class Task2 {
    public static void main(String[] args) {
        ...
        countRepeats(uniquePlanets, counts,planets);
        printPlanetsCounts(uniquePlanets, counts);
    }
    private static void countRepeats(ArrayList<String> uniquePlanets, ArrayList<Integer> counts,ArrayList<String> planets ){
